...
import { GET_CONTACT_US } from "@/graphql/queries";
import HeaderMenu from "@/components/HeaderMenu";
import Footer from "@/components/Footer";


function PrivacyNotice(props: any) {
  ...
  return(
    <>
      ...
      <NextSeo
        title={props.contact.data.attributes.seo.metaTitle}
        description={props.contact.data.attributes.seo.metaDescription}
        canonical={props.contact.data.attributes.seo.canonicalURL}
      />
      <Box
        maxWidth="1216px"
        margin="0 auto"
      ...
      >
        ...
        fontWeight="800"
      >
        {props.contact.data.attributes.title}
      </Heading>
      <Flex
        columnGap="128px"
      ...
      >
        <Box>
          <Text
            ...
            mb="32px"
          >
            {props.contact.data.attributes.description}
          </Text>
          <Box
            bgColor="#fff"
            as="article"
          ...
          <Box>
            ...
            >
              <Text
                ...
                lineHeight="28px"
              >
                {props.contact.data.attributes.ourCommitment}
              </Text>
            </Box>
          </Box>
          ...
          <Box>
            ...
            >
              <Text
                ...
                mb="24px"
              >
                {props.contact.data.attributes.artDescription}
              </Text>
              <Box >
                <ChakraLink
                  as={Link}
                  htef={`phone:${props.contact.data.attributes.artPhone}`}
                  fontWeight="500"
                  fontSize="16px"
                  lineHeight="24px"
                  color="gray.500"
                ...
                >
                  <PhoneIcon /> {props.contact.data.attributes.artPhone}
                </ChakraLink>
                <ChakraLink
                  as={Link}
                  htef={`mailto:${props.contact.data.attributes.artEmail}`}
                  fontWeight="500"
                  fontSize="16px"
                  lineHeight="24px"
                  color="gray.500"
                  ...
                  _hover={{ textDecor: "none" }}
                >
                  <EmailIcon /> {props.contact.data.attributes.artEmail}
                </ChakraLink>
                <Text
                  fontWeight="500"
                  fontSize="16px"
                ...
                >
                  ...
                  {props.contact.data.attributes.artAddress}
                </Text>
              </Box>
            </Box>
          </Box>
