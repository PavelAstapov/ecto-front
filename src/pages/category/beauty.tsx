...
import { getBeautyPage, getLatestPostsByCategory } from "@/components/api/api.service";
...
export default function PostPage() {
	...
	const categorieData = async () => {
		const fetchedData = await getBeautyPage();
	...
	const updateAticlesList = async () => {
		try {
			const fetchedData = await getLatestPostsByCategory('Beauty', page!);
