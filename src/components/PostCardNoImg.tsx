...
import { BlogPostsMainData, MainBanner, PreviewBlogData } from '@/Types/types';
...
function PostCardNoImg ({ item, isOnBanner = false }: Props) {
	...
	const { url, title, readingTime } = item.attributes
			...
			>
				...
				>
					<Text
						...
						flex="1"
					>
						By {item.attributes.author.data.attributes.name}
					</Text>
